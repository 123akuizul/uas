...
with data_set_description:
    ...
    st.write("""5. Kolom Lemak Susu ini mendefinisikan Lemak susu yang merupakan data kategori 0 (Buruk) atau 1 (Baik) maks : 0 (Buruk)""")
    st.write("""6. Kolom Kekeruhan Susu ini mendefinisikan Kekeruhan susu yang merupakan data kategorikal 0 (Rendah) atau 1 (Tinggi) maks : 1""")
    st.write("""7. Kolom Warna Susu ini menentukan Warna susu yang berkisar dari 240 hingga 255 maks : 255""")
    st.write("""8. Kolom Target ini mendefinisikan Grade (Target) susu yang merupakan data kategori Dimana Rendah (Buruk) atau Sedang (Sedang)""")
